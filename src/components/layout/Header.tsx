    ...
    <header className="fixed left-0 right-0 top-0 z-40 max-w-full border-b border-white/40 bg-white/75 shadow-[0_8px_40px_-28px_rgba(15,23,42,0.55)] backdrop-blur-2xl dark:border-slate-800/70 dark:bg-slate-950/72">
      <div className="mx-auto min-w-0 max-w-[88rem] px-3 sm:px-6 lg:px-8 xl:px-10">
        <div className="flex h-14 items-center justify-between gap-3 sm:h-16 sm:gap-4">
          ...
          {/* Desktop Navigation */}
          <nav className="hidden items-center gap-1 rounded-full border border-slate-200/70 bg-white/55 p-1 shadow-sm backdrop-blur dark:border-slate-800/80 dark:bg-slate-900/45 lg:flex">
        ...
        <div
          className={cn(
            ...
            isMenuOpen ? 'max-h-[calc(100dvh-4rem)] overflow-y-auto pb-3 sm:pb-4' : 'max-h-0'
          )}
        >
          <nav className="space-y-3 rounded-3xl border border-slate-200/70 bg-white/90 p-3 shadow-xl shadow-slate-950/5 backdrop-blur-xl dark:border-slate-800 dark:bg-slate-900/90">
            <div>
