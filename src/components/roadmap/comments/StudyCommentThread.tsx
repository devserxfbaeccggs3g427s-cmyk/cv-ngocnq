...
export function StudyCommentThread({
  ...
  return (
    <section className="card mt-6 p-3 sm:p-4">
      <div className="mb-4 flex items-center gap-2">
        <MessageSquareText className="h-5 w-5 text-[var(--accent)]" />
        <div>
          <h3 className="text-lg font-bold text-[var(--fg)] sm:text-sm">Comment và hỏi AI</h3>
          <p className="text-base leading-7 text-[var(--fg-muted)] sm:text-xs sm:leading-normal">
      ...
      {!context && (
        <div className="card mb-4 border-[var(--warn)] px-3 py-3 text-lg leading-8 text-[var(--warn)] sm:py-2 sm:text-sm sm:leading-normal">
      ...
      {error && (
        <div className="card mt-3 border-[var(--accent)] px-3 py-3 text-lg leading-8 text-[var(--accent)] sm:py-2 sm:text-sm sm:leading-normal">
          {error}
        </div>
      )}
      ...
      <div className="mt-4 space-y-3">
        {commentTree.length === 0 ? (
          <p className="rounded-[var(--radius-card)] border border-dashed border-[var(--line)] bg-[var(--surface)] px-3 py-5 text-center text-lg leading-8 text-[var(--fg-muted)] sm:py-4 sm:text-sm sm:leading-normal">
